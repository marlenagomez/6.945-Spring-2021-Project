...
(write-to-file (run-cse (read-doc "test-run5/test-case5.scm")) 
	       "test-run5/test-output5.scm")
...
(write-to-file (compress my-library (read-doc "test-run5/test-case5.scm"))
	       "test-run5/test-output5-1.scm")
